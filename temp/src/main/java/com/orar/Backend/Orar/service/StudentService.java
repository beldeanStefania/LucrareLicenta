...
public class StudentService {
    ...
    public Student getByCod(String cod) throws StudentNotFoundException {
        return studentRepository.findByCod(cod)
                .orElseThrow(() -> new StudentNotFoundException("Student not found with cod: " + cod));
    }
